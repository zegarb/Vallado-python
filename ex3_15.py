...
from space_conversions import ecef2eci, eci2ecef
...
recig, vecig, aecig = ecef2eci(recef, vecef, aecef, ttt, jdut1+jdut1frac, lod,
                               xp, yp, 2, ddpsi, ddeps)
print('GCRF 2 w corr IAU-76/FK5: ')
print(' r: \n' , (recig))
print(' v: \n' , (vecig))
print(' a: \n' , (aecig))

recef, vecef, aecef = eci2ecef(recig, vecig, aecig, ttt, jdut1+jdut1frac, lod,
                                xp, yp, 2, ddpsi, ddeps)
print('ecef 2wo corr:')
print(' r: \n' , (recef))
print(' v: \n' , (vecef))
