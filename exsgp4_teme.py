...
jdtdb, jdtdbfrac = stu.convtime(year, mon, day, hr, min, sec,
                                timezone, dut1, dat)
print('ut1 %8.6f tut1 %16.12f jdut1 %18.11f \n' % (ut1, tut1, jdut1))
# ---------------------- teme transformations ---------------------
# -------- ecef2teme    - transform ecef to teme vectors
rteme, vteme, ateme = sc.ecef2teme(recef, vecef, aecef, ttt, jdut1 + jdut1frac,
                                   lod, xp, yp, eqeterms)
print('\n\n start from ecef \n')
print(f'ecef-teme\n rteme \n{rteme}')
print(f' vteme \n{vteme}')
# -------- teme2ecef    - transform teme to ecef vectors
recef1, vecef1, aecef1 = sc.teme2ecef(rteme, vteme, ateme, ttt,
...
recig, vecig, aecig = sc.ecef2eci(recef, vecef, aecef, ttt, jdut1 + jdut1frac,
...
year, mon, day, hr, min, sec = stu.invjday(satrec['jdsatepoch'],
                                           satrec['jdsatepochf'])
dut1 = 0.2052872
dat = 32
...
# -------- teme2ecef    - transform teme to ecef vectors
recefd, vecefd, aecefd = sc.teme2ecef(rteme, vteme, ateme, ttt,
                                      jdut1 + jdut1frac, lod, xp, yp, eqeterms)
...
reci, veci, aeci = sc.ecef2eci(recefd, vecefd, aecefd, ttt, jdut1 + jdut1frac,
                               lod, xp, yp, 2, ddpsi, ddeps)
...
recefe, vecefe, aecefe = sc.eci2ecef(recie, vecie, aecie, ttt,
                                     jdut1 + jdut1frac, lod, xp, yp, eqeterms,
                                     ddpsi, ddeps)
