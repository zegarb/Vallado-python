...
print('\n-------- lambertu test \n' % ())
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, dm, de, nrev, dtsec, tbidu, fid)
print(' v1t \n',  (v1t))
print(' v2t \n',  (v2t))
...
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'S', 'L', 0, dtsec, tbidu, fid)
print(' v1t \n',  (v1t))
print(' v2t \n',  (v2t))
print(' TEST ------------------ L  H  0 rev \n' % ())
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'L', 'H', 0, dtsec, tbiru, fid)
print(' v1t \n',  (v1t))
print(' v2t \n',  (v2t))
print(' TEST ------------------ S  L  1 rev \n' % ())

v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'S', 'L', 1, dtsec, tbidu, fid)
print('uv1t \n',  (v1t))
print(' v2t \n',  (v2t))
print(' TEST ------------------ S  H  1 rev \n' % ())
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'S', 'H', 1, dtsec, tbidu, fid)
print('uv1t \n',  (v1t))
print(' v2t \n',  (v2t))
print(' TEST ------------------ L  L  1 rev \n' % ())
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'L', 'L', 1, dtsec, tbiru, fid)
print('uv1t \n',  (v1t))
print(' v2t \n',  (v2t))
print(' TEST ------------------ L  H  1 rev \n' % ())
v1t, v2t, errorl = obu.lambertu(r1, v1, r2, 'L', 'H', 1, dtsec, tbiru, fid)
print('uv1t \n',  (v1t))
print(' v2t \n',  (v2t))
