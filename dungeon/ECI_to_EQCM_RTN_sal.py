...
def ECI_to_EQCM_RTN_sal(r_tgt_ECI = None,v_tgt_ECI = None,r_int_ECI = None,v_int_ECI = None): 
...
#  to go from target to interceptor (lambda_tgt will be 0)
    ...
    cos_phi = np.cos(phi)
    lambda_ = atan2(r_int_RTN1(2,1),r_int_RTN1(1,1))
...
# times
    ...
    r_int_EQCM[2,1] = (a_tgt * (E1 - E0 + fixit))
