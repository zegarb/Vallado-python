import numpy as np
from spacemath_utils import mag, cubicinterp
...
def findjpldeparam(jdtdb = None,jdtdbF = None,interp = None,jpldearr = None,jdjpldestart = None):
    #Int32 recnum;
#Int32 off1, off2;
...
# check if any whole days in jdF
    jdb = int(np.floor(jdtdb + jdtdbF)) + 0.5
    ...
    jdjpldestarto = int(np.floor(jdtdb + jdtdbF - jdjpldestart))
    recnum = int(np.floor(jdjpldestarto))
    # check for out of bound values
    rsun = np.empty(3)
    rmoon = np.empty(3)
    if ((recnum >= 1) and (recnum <= 51830)):
...
#printf("recnum l #i fixf #lf #lf rsun #lf #lf #lf \n", recnum, fixf, jpldearr.rsun(1), rsun(1), rsuny, rsunz);
        ...
        if (interp == 's'):
            ...
            rsun[0] = cubicinterp(jpldearr.rsun1(recnum - off1),jpldearr.rsun1(recnum),jpldearr.rsun1(recnum + off1),jpldearr.rsun1(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rsun[1] = cubicinterp(jpldearr.rsun2(recnum - off1),jpldearr.rsun2(recnum),jpldearr.rsun2(recnum + off1),jpldearr.rsun2(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rsun[2] = cubicinterp(jpldearr.rsun3(recnum - off1),jpldearr.rsun3(recnum),jpldearr.rsun3(recnum + off1),jpldearr.rsun3(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rsmag = mag(rsun)
            rmoon[0] = cubicinterp(jpldearr.rmoon1(recnum - off1),jpldearr.rmoon1(recnum),jpldearr.rmoon1(recnum + off1),jpldearr.rmoon1(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rmoon[1] = cubicinterp(jpldearr.rmoon2(recnum - off1),jpldearr.rmoon2(recnum),jpldearr.rmoon2(recnum + off1),jpldearr.rmoon2(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rmoon[2] = cubicinterp(jpldearr.rmoon3(recnum - off1),jpldearr.rmoon3(recnum),jpldearr.rmoon3(recnum + off1),jpldearr.rmoon3(recnum + off2),jpldearr.mjd(recnum - off1),jpldearr.mjd(recnum),jpldearr.mjd(recnum + off1),jpldearr.mjd(recnum + off2),jpldearr.mjd(recnum) + fixf)
            rmmag = mag(rmoon)
