...
match scenario:
    case 0:
        jd1,jd1f = stu.jday(1805,9,5,24,16,5.0)
        rtasc1 = 95.98975 * deg2rad
        decl1 = 22.35752222 * deg2rad
        jd2,jd2f = stu.jday(1806,1,17,22,9,5.0)
        rtasc2 = 101.3112083 * deg2rad
        decl2 = 30.35672222 * deg2rad
        jd3,jd3f = stu.jday(1806,5,23,20,39,9.0)
        ...
        r2ans = np.array([float('nan'),float('nan'),float('nan')])
    case 1:
        # ---------------------ceres orbital observations
        jd1,jd1f = stu.jday(1990,1,1,0,0,0.0)
        rtasc1 = sc.hms2rad(5,41,14.1)
        decl1 = sc.dms2rad(26,26,0.0)
        jd2,jd2f = stu.jday(1990,6,12,0,0,0.0)
        rtasc2 = sc.hms2rad(7,59,30.5)
        decl2 = sc.dms2rad(26,58,15.0)
        jd3,jd3f = stu.jday(1990,12,25,0,0,0.0)
...
# mu = musun = 1.32712428e11 km2/s3 for interplanatary
r2,v2 = obu.anglesg(decl1,decl2,decl3,rtasc1,rtasc2,rtasc3,jd1, jd1f,jd2, jd2f,jd3, jd3f,rsite1,rsite2,rsite3,musun)
#r2,v2 = obu.anglesl(decl1,decl2,decl3,rtasc1,rtasc2,rtasc3,jd1, jd1f,jd2, jd2f,jd3, jd3f,'y',rsite1,rsite2,rsite3,musun)
# This is not working right now for boundary hyperbolic cases (need to fix it) - mjc
#r2, v2 = obu.anglesdr(decl1,decl2,decl3,rtasc1,rtasc2,rtasc3,jd1, jd1f,jd2, jd2f,jd3, jd3f,rsite1,rsite2,rsite3,au,musun)
...
p,a,ecc,incl,omega,argp,nu,m,arglat,truelon,lonper = sc.rv2coe(r2,v2,musun)
...
r2,v2 = sc.coe2rv(p,ecc,incl,omega,argp,nu,arglat,truelon,lonper,musun)
